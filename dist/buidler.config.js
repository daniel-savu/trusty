...
config_1.task("balance", "Prints an account's balance")
    ...
    .setAction(function (taskArgs, bre) { return __awaiter(void 0, void 0, void 0, function () {
    var account, balance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                account = bre.web3.utils.toChecksumAddress(taskArgs.account);
                return [4 /*yield*/, bre.web3.eth.getBalance(account)];
            case 1:
                balance = _a.sent();
